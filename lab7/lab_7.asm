...
; [НОВОЕ] Данные для проверки пароля
; Пароль: Y A R I K
...
Int09Hand proc
    ...
    ; [ИЗМЕНЕНО] Проверка комбинации блокировки
...
; --- [НОВОЕ] ЦИКЛ ОЖИДАНИЯ ПАРОЛЯ "YARIK" ---
  ...
  KbdWait:                
    ...
    ; =================================================
    ; [FIX] ПАРОЛЬ ВЕРЕН. ЖДЕМ ОТПУСКАНИЯ КЛАВИШИ
    ; =================================================
  ...
  Exit009:
    ...
    mov   AL,ES:[417h]  ;│Shift/Ctrl/Alt, чтобы система не думала,
    and   AL,11110000b  ;│что они все еще зажаты
    mov   ES:[417h], AL ;┘
